...
class AWSBedrockLLM(LLMBase):
    def __init__(self, config: Optional[BaseLlmConfig] = None):
        ...
        self.config.model = os.environ.get("AWS_LLM_MODEL", "arn:aws:bedrock:us-east-1:070374294862:inference-profile/us.meta.llama4-scout-17b-instruct-v1:0")

        if not self.config.model:
            self.config.model = "arn:aws:bedrock:us-east-1:070374294862:inference-profile/us.meta.llama4-scout-17b-instruct-v1:0"
